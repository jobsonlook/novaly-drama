...
func (m *Manager) Start() error {
	...
	cmd.Env = append(cmd.Env, "PORT=8086", "DOUBAO_CDP_PORT=9322", "DOUBAO_CDP_URL=http://127.0.0.1:9322", "MAX_PARALLEL_VIDEO=2", "DOUBAO_SESSION_DIR="+filepath.Join(m.root, "session"))
